...
class TopicDdosAttackView extends GetView<TopicDdosAttackController> {
  const TopicDdosAttackView({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            widgetCourse.title('What is a DDoS attack?'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.title('How does a DDoS attack work?'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.title('What are some common types of DDoS attacks?'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(4),
            widgetCourse.image(ConstantsAssetImage.imageDDoS),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.title('Application layer attacks'),
            const Gap(4),
            widgetCourse.subtitle('The goal of the attack:'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.subtitle('Application layer attack example:'),
            const Gap(4),
            widgetCourse.image(ConstantsAssetImage.imageDDoS2),
            const Gap(6),
            widgetCourse.subtitle('HTTP flood'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.title('Protocol attacks'),
            const Gap(4),
            widgetCourse.subtitle('The goal of the attack:'),
            const Gap(6),
            widgetCourse.body(
...
""",
            ...
            const Gap(6),
            widgetCourse.subtitle('Protocol attack example:'),
            const Gap(4),
            widgetCourse.image(ConstantsAssetImage.imageDDoS3),
            const Gap(6),
            widgetCourse.subtitle('SYN flood'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.title('Volumetric attacks'),
            const Gap(4),
            widgetCourse.subtitle('The goal of the attack:'),
            const Gap(4),
            widgetCourse.body(
...
""",
            ...
            const Gap(6),
            widgetCourse.subtitle('Amplification example:'),
            const Gap(4),
            widgetCourse.image(ConstantsAssetImage.imageDDoS4),
            const Gap(6),
            widgetCourse.subtitle('DNS Amplification'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse
                .title('What is the process for mitigating a DDoS attack?'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.subtitle('Blackhole routing'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.subtitle('Rate limiting'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.subtitle('Web application firewall'),
            const Gap(4),
            widgetCourse.body(
              """
...
""",
            ...
            const Gap(6),
            widgetCourse.subtitle('Anycast network diffusion'),
            const Gap(4),
            widgetCourse.body(
              """
